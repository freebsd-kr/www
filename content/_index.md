...
최신 버전은 [14.4-RELEASE](https://www.freebsd.org/releases/14.4R/announce/)
 (2026/3/10) 입니다.

* https://ftp.kr.freebsd.org/pub/FreeBSD/releases/ISO-IMAGES/14.4/ ISO/USB/SD카드 설치 이미지 다운로드
* https://ftp.kr.freebsd.org/pub/FreeBSD/releases/VM-IMAGES/14.4-RELEASE/ 가상머신 이미지 다운로드

## 개발 버전

최신 개발 버전은 **16.0-CURRENT** 입니다.

### 16.0-CURRENT

* https://ftp.kr.freebsd.org/pub/FreeBSD/snapshots/ISO-IMAGES/16.0/ 16.0-CURRENT ISO/USB/SD카드 설치 이미지 다운로드
* https://ftp.kr.freebsd.org/pub/FreeBSD/snapshots/VM-IMAGES/16.0-CURRENT/ 16.0-CURRENT 가상머신 이미지 다운로드
